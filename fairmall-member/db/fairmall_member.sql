...
CREATE TABLE `member`  (
  ...
  `header` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '头像',
  ...
  `integration` int(0) NOT NULL DEFAULT 0 COMMENT '积分',
  `growth` int(0) NOT NULL DEFAULT 0 COMMENT '成长值',
